...
public class Secp256r1AgreementAdapter : SecpBaseAgreementAdapter, IAsymmetricBase, IAsymmetricCipher<HkdfParameters>
{
    private static readonly Lazy<Secp256r1AgreementAdapter> _instance = new(() => new());
    private Secp256r1AgreementAdapter() : base(oid, 256) { }
    public static Secp256r1AgreementAdapter Instance { get { return _instance.Value; } }
