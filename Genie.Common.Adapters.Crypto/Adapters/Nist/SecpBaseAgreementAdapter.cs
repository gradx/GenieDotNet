...
public abstract class SecpBaseAgreementAdapter(string oid, int keySize)
{
    ...
    public X509Certificate2 ExportX509PublicCertificate(ECDiffieHellman ecdh, string issuer)
    {
