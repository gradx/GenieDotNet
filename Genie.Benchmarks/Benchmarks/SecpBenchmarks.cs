...
namespace Genie.Benchmarks.Benchmarks
{
    public class SecpBenchmarks : EncryptionBenchmarkBase
    {
        ...
        public SecpBenchmarks()
        {
            ...
            // secp256r1
            secp256r1_signing_private = Secp256r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp256r1_key,
                IsPrivate = true
            })!;

            secp256r1_signing_public = Secp256r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp256r1_cer,
                IsPrivate = false
            })!;
            ...
            // secp384r1
            secp384r1_signing_private = Secp384r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp384r1_key,
                IsPrivate = true
            })!;

            secp384r1_signing_public = Secp384r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp384r1_cer,
                IsPrivate = false
            })!;
            ...
            // secp521r1
            secp521r1_signing_private = Secp521r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp521r1_key,
                IsPrivate = true
            })!;

            secp521r1_signing_public = Secp521r1SigningAdapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = secp521r1_cer,
                IsPrivate = false
            })!;
        ...
        public void Bouncy_Secp256k1_Exchange_Sender()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp256k1Adapter.CreateSecret((ECPrivateKeyParameters)secp256k1_b_alice.Private, (ECPublicKeyParameters)secp256k1_b_bob.Public);
            });
        }
        ...
        public void Bouncy_Secp256k1_Exchange_Receiver()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp256k1Adapter.CreateSecret((ECPrivateKeyParameters)secp256k1_b_bob.Private, (ECPublicKeyParameters)secp256k1_b_alice.Public);
            });
        }
        ...
        public void Bouncy_Secp256r1_Exchange_Sender()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp256r1Adapter.CreateSecret((ECPrivateKeyParameters)secp256r1_b_alice.Private, (ECPublicKeyParameters)secp256r1_b_bob.Public);
            });
        }
        ...
        public void Bouncy_Secp256r1_Exchange_Receiver()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp256r1Adapter.CreateSecret((ECPrivateKeyParameters)secp256r1_b_bob.Private, (ECPublicKeyParameters)secp256r1_b_alice.Public);
            });
        }
        ...
        public void Bouncy_Secp384r1_Exchange_Sender()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp384r1Adapter.CreateSecret((ECPrivateKeyParameters)secp384r1_b_alice.Private, (ECPublicKeyParameters)secp384r1_b_bob.Public);
            });
        }
        ...
        public void Bouncy_Secp384r1_Exchange_Receiver()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp384r1Adapter.CreateSecret((ECPrivateKeyParameters)secp384r1_b_bob.Private, (ECPublicKeyParameters)secp384r1_b_alice.Public);
            });
        }
        ...
        public void Bouncy_Sec521r1_Exchange_Sender()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp521r1Adapter.CreateSecret((ECPrivateKeyParameters)secp521r1_b_alice.Private, (ECPublicKeyParameters)secp521r1_b_bob.Public);
            });
        }
        ...
        public void Bouncy_Sec521r1_Exchange_Receiver()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                var result = Secp521r1Adapter.CreateSecret((ECPrivateKeyParameters)secp521r1_b_bob.Private, (ECPublicKeyParameters)secp521r1_b_alice.Public);
            });
        }
        ...
        public void Secp256r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = secp256r1_key });
            });
        ...
        public void Secp256r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                ...
                Secp256r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = false, X509 = secp256r1_cer });
            });
        ...
        public void Secp384r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp384r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = secp384r1_key });
            });
        ...
        public void Secp384r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp384r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = false, X509 = secp384r1_cer });
            });
        ...
        public void Secp521r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp521r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = secp521r1_key });
            });
        ...
        public void Secp521r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp521r1SigningAdapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = false, X509 = secp521r1_cer });
            });
