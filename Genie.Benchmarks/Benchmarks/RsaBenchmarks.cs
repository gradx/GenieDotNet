...
namespace Genie.Benchmarks.Benchmarks
{
    public class RsaBenchmarks : EncryptionBenchmarkBase
    {
        ...
        {
            rsa1024_alice = Rsa1024Adapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = rsa1024_key,
                IsPrivate = true
            })!;
            ...
            rsa2048_alice = Rsa2048Adapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = rsa2048_key,
                IsPrivate = true
            })!;
            ...
            rsa4096_alice = Rsa4096Adapter.Import(new Common.Types.GeoCryptoKey
            {
                X509 = rsa4096_key,
                IsPrivate = true
            })!;
        ...
        public void Rsa1024_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Rsa1024Adapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = rsa1024_key });
            });
        }
        ...
        public void Rsa2048_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Rsa2048Adapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = rsa2048_key });
            });
        }
        ...
        public void Rsa4096_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Rsa2048Adapter.Import(new Common.Types.GeoCryptoKey { IsPrivate = true, X509 = rsa4096_key });
            });
        }
