...
using Genie.Benchmarks.Persistence.Country;
using Genie.Benchmarks.Persistence.Balance;
...
await JsonWrite.Neo4j();
CounterConsoleLogger.Reset();

await JsonRead.Neo4j();
Console.WriteLine("Completed");

//await CountryUpdate.Marten();
////await CountryQuery.ClickHouse();
////await CountrySelfJoin.ClickHouse();

//Console.ReadLine();

//var aeroTest = new AerospikeTest();
//aeroTest.RunTests(1);

//var arangoTest = new ArangoTest(true);
//arangoTest.RunTests(1);

//var cassTest = new CassandraTest();
//cassTest.CreateDB();
//cassTest.RunTests(1);

//var clickTest = new ClickHouseTest();
//clickTest.CreateDB();
//clickTest.RunTests(2);

//var cockTest = new CockroachTest();
//cockTest.CreateDB();
//cockTest.RunTests(2);

//var couchbaseTest = new CouchbaseTest(true);
//couchbaseTest.RunTests(1);
//couchbaseTest.RunTests(2);

//var couchTest = new CouchTest();
//couchTest.RunTests(1);

//var crateTest = new CrateTest();
//crateTest.CreateDB();
//crateTest.RunTests(1);
...
//var elasticTest = new ElasticTest();
//elasticTest.RunTests(1);

//var maria = new MariaTest();
//maria.CreateDB();
//maria.RunTests(1);

//var martenTest = new MartenTest();
//martenTest.RunTests(1);

//var milvusTest = new MilvusTest(true);
//milvusTest.RunTests(1);

//var mongoTest = new MongoTest();
//mongoTest.RunTests(1);


//var mysql = new MariaTest();
//mysql.CreateMySqlDB();
//mysql.RunTests(1);
//mysql.RunTests(2);


//var neoTest = new Neo4jTest(true);
//neoTest.RunTests(1);

//var oracleTest = new OracleTest();
//oracleTest.CreateDB();
//oracleTest.RunTests(1);
//oracleTest.RunTests(2);

//var postgresTest = new PostgresTest();
//postgresTest.CreateDB();
//postgresTest.RunTests(1);




//var ravenTest = new RavenTest(true);
//ravenTest.RunTests(1);

//var redisTest = new RedisTest();
//redisTest.RunTests(1);

//var scyllaTest = new ScyllaTest();
//scyllaTest.CreateDB();
//scyllaTest.RunTests(1);

//var singleStoreTest = new SingleStoreTest();
//singleStoreTest.CreateDB();
//singleStoreTest.RunTests(1);
//singleStoreTest.RunTests(2);

//var sqlServerTest = new SqlServerTest();
//sqlServerTest.CreateDB();
//sqlServerTest.RunTests(1);
//sqlServerTest.RunTests(2);
...
public class BrokerBenchmarks
{
    ...
    private readonly IChannel? rabbitIngress;
    private readonly IChannel? rabbitEvents;
