...
namespace Genie.Benchmarks.Benchmarks.Encryption
{
    public class ModuleLatticeBenchmarks : EncryptionBenchmarkBase
    {
        ...
        public ModuleLatticeBenchmarks()
        {
            ...
            // Dilthium
            dilithium3_private = DilithiumAdapter.Import(new GeoCryptoKey
            {
                X509 = dilithium3_private_key,
                IsPrivate = true
            });

            dilithium3_public = DilithiumAdapter.Import(new GeoCryptoKey
            {
            ...
            dilithium5_private = DilithiumAdapter.Import(new GeoCryptoKey
            {
                X509 = dilithium5_private_key,
                IsPrivate = true
            });

            dilithium5_public = DilithiumAdapter.Import(new GeoCryptoKey
            {
            ...
            dilithium2_private = DilithiumAdapter.Import(new GeoCryptoKey
            {
                X509 = dilithium2_private_key,
                IsPrivate = true
            });

            dilithium2_public = DilithiumAdapter.Import(new GeoCryptoKey
            {
        ...
        public void Dilithium2_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = dilithium2_private_key });
            });
        }
        ...
        public void Dilithium2_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = dilithium2_public_cer });
            });
        }
        ...
        public void Dilithium3_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = dilithium3_private_key });
            });
        }
        ...
        public void Dilithium3_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = dilithium3_public_cer });
            });
        }
        ...
        public void Dilithium5_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = dilithium5_private_key });
            });
        }
        ...
        public void Dilithium5_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                DilithiumAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = dilithium5_public_cer });
            });
        }
        ...
        public void Kyber512_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = kyber512_private_key });
            });
        }
        ...
        public void Kyber512_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = kyber512_public_cer });
            });
        }
        ...
        public void Kyber768_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = kyber768_private_key });
            });
        }
        ...
        public void Kyber768_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = kyber768_public_cer });
            });
        }
        ...
        public void Kyber1024_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = kyber1024_private_key });
            });
        }
        ...
        public void Kyber1024_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                KyberAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = kyber1024_public_cer });
            });
        }
