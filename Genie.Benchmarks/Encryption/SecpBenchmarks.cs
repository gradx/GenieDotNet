...
namespace Genie.Benchmarks.Benchmarks.Encryption
{
    public class SecpBenchmarks : EncryptionBenchmarkBase
    {
        ...
        public SecpBenchmarks()
        {
            ...
            // secp256r1
            secp256r1_signing_private = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp256r1_key,
                IsPrivate = true
            })!;

            secp256r1_signing_public = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp256r1_cer,
                IsPrivate = false
            })!;
            ...
            // secp384r1
            secp384r1_signing_private = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp384r1_key,
                IsPrivate = true
            })!;

            secp384r1_signing_public = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp384r1_cer,
                IsPrivate = false
            })!;
            ...
            // secp521r1
            secp521r1_signing_private = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp521r1_key,
                IsPrivate = true
            })!;

            secp521r1_signing_public = SecpBaseSigningAdapter.Import(new GeoCryptoKey
            {
                X509 = secp521r1_cer,
                IsPrivate = false
            })!;
        ...
        public void Bouncy_Secp256k1_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256k1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp256k1_signing_key });
            });
        ...
        public void Bouncy_Secp256k1_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256k1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp256k1_signing_cer });
            });
        ...
        public void Bouncy_Secp256r1_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp256r1_key });
            });
        ...
        public void Bouncy_Secp256r1_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = bouncy_256r1_public });
            });
        ...
        public void Bouncy_Secp384r1_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp384r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp384r1_key });
            });
        ...
        public void Bouncy_Secp384r1_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp384r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = bouncy_384r1_public });
            });
        ...
        public void Bouncy_Secp521r1_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp521r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp521r1_key });
            });
        ...
        public void Bouncy_Secp521r1_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp521r1Adapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = bouncy_521r1_public });
            });
        ...
        public void Secp256r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp256r1_key });
            });
        ...
        public void Secp256r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                ...
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp256r1_cer });
            });
        ...
        public void Secp256r1_ImportAgreementKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp256r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp256r1_key });
            });
        ...
        public void Secp256r1_ImportAgreementKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                ...
                Secp256r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp256r1_cer });
            });
        ...
        public void Secp384r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp384r1_key });
            });
        ...
        public void Secp384r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp384r1_cer });
            });
        ...
        public void Secp384r1_ImportAgreementKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp384r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp384r1_key });
            });
        ...
        public void Secp384r1_ImportAgreementKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                ...
                Secp384r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp384r1_cer });
            });
        ...
        public void Secp521r1_ImportSigningKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp521r1_key });
            });
        ...
        public void Secp521r1_ImportSigningKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                SecpBaseSigningAdapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp521r1_cer });
            });
        ...
        public void Secp521r1_ImportAgreementKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Secp521r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = true, X509 = secp521r1_key });
            });
        ...
        public void Secp521r1_ImportAgreementKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                ...
                Secp521r1AgreementAdapter.Instance.Import(new GeoCryptoKey { IsPrivate = false, X509 = secp521r1_cer });
            });
