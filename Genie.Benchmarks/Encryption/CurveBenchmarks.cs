...
namespace Genie.Benchmarks.Benchmarks.Encryption
{
    public class CurveBenchmarks : EncryptionBenchmarkBase
    {
        ...
        public CurveBenchmarks()
        {
            ...
            // Ed25519
            ed25519_private = Ed25519Adapter.Import(new GeoCryptoKey
            {
                X509 = ed25519_private_bytes,
                IsPrivate = true
            });

            ed25519_public = Ed25519Adapter.Import(new GeoCryptoKey
            {
            ...
            // Ed448
            ed448_private = Ed448Adapter.Import(new GeoCryptoKey
            {
                X509 = ed448_private_bytes,
                KeyType = GeoCryptoKey.CryptoKeyType.Ed25519,
                IsPrivate = true
            });

            ed448_public = Ed448Adapter.Import(new GeoCryptoKey
            {
        ...
        public void Ed25519_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Ed25519Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = ed25519_private_bytes });
            });
        }
        ...
        public void Ed25519_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Ed25519Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = ed25519_public_bytes });
            });
        }
        ...
        public void Ed448_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Ed448Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = ed448_private_bytes });
            });
        }
        ...
        public void Ed448_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                Ed448Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = ed448_public_bytes });
            });
        }
        ...
        public void X25519_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                X25519Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = x25519_private_bytes });
            });
        }
        ...
        public void X25519_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                X25519Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = x25519_public_bytes });
            });
        }
        ...
        public void X448_ImportKey_Private()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                X448Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = x448_private_bytes });
            });
        }
        ...
        public void X448_ImportKey_Public()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                X448Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = x448_public_bytes });
            });
        }
