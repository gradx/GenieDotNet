...
namespace Genie.Benchmarks.Benchmarks.Encryption
{
    public class EncryptionTests
    {
        ...
        public static void TestBouncy()
        {
            ...
            _ = Secp256r1Adapter.Instance.Import(new GeoCryptoKey
            {
                IsPrivate = true,
                X509 = export
            });
            ...
            _ = Secp521r1Adapter.Instance.Import(new GeoCryptoKey
            {
                IsPrivate = true,
                X509 = export
            });
        ...
        public static void TestRsa4096()
        {
            ...
            _ = Rsa4096Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = alice_private_exported });

            var alice_public_exported = Rsa4096Adapter.ExportX509Certificate(alice, "Genie");
            var alice_public_imported = Rsa4096Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = alice_public_exported.RawData });
        ...
        public static void TestRsa2048()
        {
            ...
            var alice_private_imported = Rsa2048Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = alice_private_exported });

            var alice_public_exported = Rsa2048Adapter.ExportX509Certificate(alice, "Genie");
            _ = Rsa2048Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = alice_public_exported.RawData });
        ...
        public static void TestRsa1024()
        {
            ...
            var alice_private_imported = Rsa1024Adapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = alice_private_exported });

            var alice_public_exported = Rsa1024Adapter.ExportX509Certificate(alice, "Genie");
            _ = Rsa1024Adapter.Import(new GeoCryptoKey { IsPrivate = false, X509 = alice_public_exported.RawData });
