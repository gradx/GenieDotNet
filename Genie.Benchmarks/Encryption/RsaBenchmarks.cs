...
namespace Genie.Benchmarks.Benchmarks.Encryption
{
    public class RsaBenchmarks : EncryptionBenchmarkBase
    {
        ...
        {
            rsa1024_alice = RsaBaseAdapter.Import(new GeoCryptoKey
            {
                X509 = rsa1024_key,
                IsPrivate = true
            })!;
            ...
            rsa2048_alice = RsaBaseAdapter.Import(new GeoCryptoKey
            {
                X509 = rsa2048_key,
                IsPrivate = true
            })!;
            ...
            rsa4096_alice = RsaBaseAdapter.Import(new GeoCryptoKey
            {
                X509 = rsa4096_key,
                IsPrivate = true
            })!;
        ...
        public void Rsa1024_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                RsaBaseAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = rsa1024_key });
            });
        }
        ...
        public void Rsa2048_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                RsaBaseAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = rsa2048_key });
            });
        }
        ...
        public void Rsa4096_ImportKey()
        {
            Parallel.For(0, threads, new ParallelOptions { MaxDegreeOfParallelism = -1 }, iter =>
            {
                RsaBaseAdapter.Import(new GeoCryptoKey { IsPrivate = true, X509 = rsa4096_key });
            });
        }
