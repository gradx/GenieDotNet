    ...
    public class JsonRead
    {
        ...
        public static async Task OpTest(PersistenceTestBase test, int threads)
        {
            ...
            var pump = CounterPump.Run(Count, async message =>
            {
                ...
                var response = test.ReadJson(message);
        ...
        {
            await OpTest(new ClickHouseTest(), 8);
            // 2 - 338
            // 4 - 406
            // 8 - 453
        }
        ...
        {
            await OpTest(new CockroachTest(), 16);
            // 8 - 2572
            // 16 - 2921
            // 32 - 2657
        }
