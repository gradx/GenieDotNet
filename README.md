...
Like Proto.Actor (8) suffers from a low optional concurrent connection count (6-10) but also __has a very low error rate__ (33 errors with 30k req handled) while Proto.actor __is nearly errorless__!
