...
public sealed class CounterPump
{
    public static CounterPump Run(long count, Func<long, Task> processMessage, int maxDegreeOfParallelism,
    ...
    /// </summary>
    private CounterPump(long count, Func<long, Task> processMessage, int maxDegreeOfParallelism, CancellationToken ct)
    {
        Count = count;
