...
public record KafkaCommand(ObjectPool<KafkaPooledObject<EventTaskJob>> GeniePool, IAdminClient AdminClient, IProducer<string, PartyRequest> Producer, CachedSchemaRegistryClient SchemaRegistry, bool FireAndForget) : IRequest;
