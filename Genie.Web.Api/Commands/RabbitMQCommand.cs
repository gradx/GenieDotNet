...
public record RabbitMQCommand(ObjectPool<RabbitMQPooledObject<EventTaskJob, PartyBenchmarkRequest>> GeniePool, SchemaBuilder SchemaBuilder, bool FireAndForget) : IRequest;
